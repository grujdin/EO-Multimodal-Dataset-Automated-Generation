...
input_file = os.path.join(HOME_DIR, "EMDAT", "Input_Data", "public_emdat_custom_request_2024-05-12_85ae59a7-afa1-41e3-8642-596f53c2731a.xlsx")
...
output_file = os.path.join(HOME_DIR, "EMDAT", "Output_Data", "public_emdat_reduced.xlsx")
